...
function genParams() {
  console.log('🌲 Original genParams: First 5 random:', [Math.random(), Math.random(), Math.random(), Math.random(), Math.random()])
...
function generate() {
  ...
  console.log('🔍 Original: First 3 random IMMEDIATELY after page load seed:', [Math.random(), Math.random(), Math.random()])
  // Re-seed
  Math.seed(SEED)

  console.log('🌳 Original: Starting paper generation')
  console.log('🌳 Original: Random values BEFORE paper:', [Math.random(), Math.random(), Math.random()])
