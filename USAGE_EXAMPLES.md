...
```typescript
import { distance, mapval, randChoice, randGaussian, bezmh, poly } from "@shuimo/core";
...
```typescript
import { overrideMathRandom, prng, Water, stroke, blob, PolyTools, bezmh } from "@shuimo/core";
