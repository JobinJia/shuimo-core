 ...
 * Gabor noise batch.
 */
export function shuimo_gabor2d_batch(
  seed: number,
  xs: Float64Array,
  ys: Float64Array,
 ...
 */
export function shuimo_noise_init(
  perlin_seed: number,
  worley_seed: number,
  octaves: number,
  falloff: number,
 ...
 */
export function shuimo_perlin3d_batch(
  xs: Float64Array,
  ys: Float64Array,
  zs: Float64Array,
  out: Float64Array,
 ...
 */
export function shuimo_perlin_init_from_table(
  table: Float64Array,
  octaves: number,
  falloff: number,
): void;
 ...
 */
export function shuimo_worley_fbm2d(
  x: number,
  y: number,
  octaves: number,
  lacunarity: number,
...
export interface InitOutput {
  ...
  readonly shuimo_perlin2d_batch: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly shuimo_perlin3d_batch: (
    a: number,
    b: number,
    c: number,
    d: number,
