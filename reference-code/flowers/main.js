...
function leaf(args) {
  ...
  const col = args.col != undefined ? args.col : { min: [90, 0.2, 0.3, 1], max: [90, 0.1, 0.9, 1] };
  const cof = args.cof != undefined ? args.cof : (x) => x;
  const ben = args.ben != undefined ? args.ben : (x) => [normRand(-10, 10), 0, normRand(-5, 5)];
...
function stem(args) {
  ...
  const col =
    args.col != undefined ? args.col : { min: [250, 0.2, 0.4, 1], max: [250, 0.3, 0.6, 1] };
  const ben = args.ben != undefined ? args.ben : (x) => [normRand(-10, 10), 0, normRand(-5, 5)];
...
function branch(args) {
  ...
  const col = args.col != undefined ? args.col : { min: [50, 0.2, 0.8, 1], max: [50, 0.2, 0.8, 1] };
